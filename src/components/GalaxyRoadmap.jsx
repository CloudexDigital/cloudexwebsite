  ...
  return (
    ...
    >
      ...
      <p className="galaxy-text">
        ...
        designed to convert.{" "}
        <span className="text-highlight">Our services go beyond code.</span> We
        blend performance, usability, and long-term growth strategy to give your
        brand a web presence that feels alive—and works hard behind the scenes.
      </p>
